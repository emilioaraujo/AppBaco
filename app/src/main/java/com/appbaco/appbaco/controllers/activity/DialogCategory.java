...
public class DialogCategory extends DialogFragment {
    ...
    private boolean validate(View view) {
        if (this.txtCategoryName.getText().toString().isEmpty()) {
            this.txtCategoryName.setError("Tag name does not be blank");
            return false;
        }
        return true;
    }
    ...
    public AlertDialog createDialog() {
        ...
        txtCategoryName = (EditText) v.findViewById(R.id.txtTagName);
        txtCategoryDescription = (EditText) v.findViewById(R.id.txtTagDescription);
